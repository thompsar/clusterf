    ...
    def update_compounds(self, compound_ids: list):
        ...
        try:
            ...
            if not self.show_miss_compounds:
                ...
                filtered_compound_ids = compound_data.loc[
                    non_miss_mask, "Compound"
                ].tolist()
            ...
            # Always display compounds in ascending order (by string)
            filtered_compound_ids = sorted(filtered_compound_ids, key=lambda x: str(x))
            ...
            try:
                ...
                if not self.show_miss_compounds and "compound_data" in locals():
                    ...
                    compound_data = self.app.library.get_compounds(
                ...
                app_color_dict = {}
                if hasattr(self.app, "color_picker") and hasattr(
